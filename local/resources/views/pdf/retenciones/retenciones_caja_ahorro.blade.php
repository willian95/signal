...
<html>
<head>
	<title>Retenciones caja de ahorro</title>
</head>
<body>
	<?php 
	...
	<table style="width: 100%; border: 1px solid; border-collapse: collapse; page-break-after:always;">
		<thead>
			<tr style="border: 1px solid; font-size: 13px;">
				...
				<td style="border: 1px solid;">
					<strong>APORTE TRABAJADOR 5%</strong>
				</td>
				<td style="border: 1px solid;">
					<strong>APORTE EMPRESA 5%</strong>
				</td>
				<td style="border: 1px solid;">
					<strong>TOTAL</strong>
				</td>
		...
		?>
				...
				@foreach($obreros as $obrero)
					...
					<?php 
						...
						$aporte = DB::table('nomina')
										...
										->where('conceptos_nominas.id_concepto', 20134)
										->sum('conceptos_nominas.monto');
						
						$aportetotal_empleado = $aporte * 2;
						$aporte2 = ($obrero->sueldo * 0.05)*2;
						$posicion = strpos($aporte2, '.');
						$decimal = substr($aporte2, $posicion+3, 1);

						if($decimal >= 5)
						{
							$aportetotal_empleado = $aportetotal_empleado - 0.01;
						}
					...
					<tr style="border: 1px solid; font-size: 12px;">
						...
						<td style="border: 1px solid;">
							{{number_format($aportetotal_empleado, 2, ',', '.')}}
						</td>
					</tr>
			...
			<tr style="border: 1px solid; font-size: 13px;">
						...
						<td style="border: 1px solid;">
							{{number_format($subtotal_empleados * 2, 2, ',', '.')}}
						</td>
					</tr>
		...
		<tbody>
			...
			@foreach($departamentos as $departamento)
				...
				@foreach($obreros as $obrero)
					...
					<?php 
						...
						if($decimal >= 5)
						{
							$aportetotal_obrero = $aportetotal_obrero - 0.01;
						}
					...
					<tr style="border: 1px solid; font-size: 12px;">
						...
						<td style="border: 1px solid;">
							{{number_format($aportetotal_obrero * 2, 2, ',', '.')}}
						</td>
					</tr>
			...
			@endforeach
				...
				<tr style="border: 1px solid; font-size: 13px;">
						...
						<td style="border: 1px solid;">
							{{number_format($subtotal_obreros * 2, 2, ',', '.')}}
						</td>
					</tr>
					...
					<tr style="border: 1px solid; font-size: 13px;">
						...
						<td style="border: 1px solid; font-size: 14px;">
							{{number_format(($subtotal_obreros + $subtotal_empleados)* 2, 2, ',', '.')}}
						</td>
					</tr>
