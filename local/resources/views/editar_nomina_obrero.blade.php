          ...
          <tr>
            ...
            <td class="center-align">
                ...
                @if($nomina->status == 0)
            		...
            		<a class="waves-effect btn tooltipped" data-position="left" data-tooltip="Editar" href="{{url('/editar_nomina_obrero_form/'.$nomina->id)}}"><i class="material-icons">edit</i></a>
                ...
                @endif
            		...
            		<a class="waves-effect btn tooltipped" data-position="bottom" data-tooltip="Descargar txt" href="{{url('/descargar/'.$nomina->id)}}"><i class="material-icons">archive</i></a>
            		<a class="btn tooltipped waves-effect" target="_blank" data-position="top" data-tooltip="Generar Reporte" href="{{url('reporte/'.$nomina->id)}}" ><i class="material-icons">assignment</i></a>
